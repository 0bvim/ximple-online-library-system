...
public class ReservationController {
    ...
    public ResponseEntity<List<ReservationDTO>> getReservation(@RequestParam(required = false) UUID id) {
        if (id != null) {
    ...
    public ResponseEntity<ReservationDTO> reserveBook(@RequestBody ReservationBodyDTO reservationDTO) {
